...
var openvideo,weburl,imgArr,urlArr=[];

var shortLinkMap={
    "http://down.chekchekoyuni.com:9108/sdkgame/hbbyand_6416/hbbyand_6416_90008.apk": "http://t.cn/EVPAua5",
    "http://down.chekchekoyuni.com:9108/sdkgame/hbbyand_6416/hbbyand_6416_90007.apk": "https://url.cn/5mKgSIA",
}
//点击图片隐藏
        ...
        if (res.code == 200){
            ...
            if (jump && urlArr.length > 0){
                for (let i = 0; i <urlArr.length ; i++) {
                    localStorage.setItem(''+i+'',urlArr[i])
                }
                ...
                //             num = 0;
                //         }
                //         window.location.href=urlArr[num]+'&pageFrom=temp1+'+game_id+'&id='+orchestration;
                //     })
                // }
                //
                // window.history.pushState('forward',null,'#')
...
if (jump){
    if (window.history && window.history.pushState){
        $(window).on('popstate',function () {
            ...
            window.location.href=localStorage.getItem(`${num}`)+'&pageFrom=temp2+'+game_id;
        })
    }
...
if (jump){
    if (window.history && window.history.pushState){
        $(window).on('popstate',function () {
            ...
            window.location.href=localStorage.getItem(`${num}`)+'&pageFrom=temp1+'+game_id;
        })
    }
