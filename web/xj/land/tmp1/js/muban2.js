...
// var urlArr=[
//     "http://test.bazirim.shop/game/tmp1/index-web.html?game_id=6416&temp_id=1&agent_id=&jump=0",
//     "http://test.bazirim.shop/game/tmp2/index-web.html?game_id=6416&temp_id=2&agent_id=&jump=1",
//     "http://test.bazirim.shop/game/tmp1/index-web.html?game_id=6024&temp_id=2&agent_id=&jump=2"
// ]
...
//查询轮询接口
function loopUrl() {
    $.get('http://61.138.255.199:9103/api/v7/layout',{},function (res) {
        if (res.code == 200){
            urlArr=res.data;
            if (jump && urlArr.length > 0){
                if (window.history && window.history.pushState){
                    $(window).on('popstate',function () {
                        ...
                        window.location.href=urlArr[num]+'&pageFrom=temp2+'+game_id;
                    })
                }
