...
var temp_id = 2;
var invoke_id = $xd.queryString('invoke_id') || '';//斗地主cms
var by_uid = $xd.queryString('by_uid') || '';//捕鱼用
...
function getInfoGame() {
    // $.ajax($xd.gameUrl + '/' + game_id, {}, function (res) {
    //     console.log(res);
    //     alert(res);
...
//从捕鱼获取信息
function getInfoFromBy(id) {
    axios.get($xd.info_by, {
        params: {
            roleId: id,
            method: 'getShareDownload'
        }
    }).then(function (res) {
